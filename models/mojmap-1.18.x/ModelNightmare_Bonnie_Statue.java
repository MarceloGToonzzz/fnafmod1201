...
public class ModelNightmare_Bonnie_Statue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "nightmare_bonnie_statue"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(79, 28)
						.addBox(-8.05F, -2.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(62, 32)
						.addBox(6.05F, -2.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(35, 5)
						.addBox(-4.5F, 6.2429F, -2.0143F, 9.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(30, 15)
						.addBox(-3.5F, -4.2571F, -3.7143F, 7.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						.addBox(-0.5F, -3.2571F, -4.2143F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						.addBox(-5.5F, 0.2429F, -3.0143F, 11.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				...
				PartPose.offsetAndRotation(-0.09F, 5.5F, 0.0F, 0.0F, -0.5236F, 0.0F));
