...
public class ModelNightmare_Chica_Statue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "nightmare_chica_statue"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 71)
						.addBox(-8.05F, -2.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 69)
						.addBox(6.05F, -2.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(31, 11)
						.addBox(-4.5F, 6.2429F, -2.0143F, 9.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-5.5F, -3.7571F, -3.0143F, 11.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3",
				...
				PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, -1.0908F, 0.0F, 0.0F));
