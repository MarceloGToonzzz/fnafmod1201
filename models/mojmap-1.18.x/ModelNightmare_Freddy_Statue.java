...
public class ModelNightmare_Freddy_Statue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "nightmare_freddy_statue"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(79, 28)
						.addBox(-8.05F, -13.6F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(62, 32)
						...
						.addBox(-5.5F, -10.5F, -5.0F, 11.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
