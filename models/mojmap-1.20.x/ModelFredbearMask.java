	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(9, 16)
						...
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(1.5F)).texOffs(41, 23)
						.addBox(-2.5F, -10.0F, -2.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.1F)).texOffs(22, 20)
						.addBox(-1.5F, -13.0F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
