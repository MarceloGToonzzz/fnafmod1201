...
public class ModelSparkySuit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sparkysuit"), "main");
	private final ModelPart Head;
	private final ModelPart SparkyHead;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition SparkyHead = Head.addOrReplaceChild("SparkyHead",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -3.6F, -5.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.1F)).texOffs(32, 17)
		...
		PartDefinition RightEyebrow = SparkyHead.addOrReplaceChild("RightEyebrow", CubeListBuilder.create(),
		...
		PartDefinition LeftEyebrow = SparkyHead.addOrReplaceChild("LeftEyebrow", CubeListBuilder.create(),
				PartPose.offset(2.0F, -5.3968F, -4.4077F));
		...
		PartDefinition Ears = SparkyHead.addOrReplaceChild("Ears", CubeListBuilder.create().texOffs(8, 47).addBox(-5.0F,
				1.3587F, 1.5F, 10.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.5587F, -2.5F));

		PartDefinition Head_r3 = Ears.addOrReplaceChild("Head_r3",
				CubeListBuilder.create().texOffs(0, 39).addBox(-0.5F, -1.0F, -3.5F, 1.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.75F, 3.1087F, 3.5F, 0.0F, 0.0F, -0.3054F));

		PartDefinition Head_r4 = Ears.addOrReplaceChild("Head_r4",
				CubeListBuilder.create().texOffs(0, 39).mirror()
						.addBox(-0.5F, -1.0F, -3.5F, 1.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-4.75F, 3.1087F, 3.5F, 0.0F, 0.0F, 0.3054F));
		...
		PartDefinition Body = Head.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(32, 0)
						...
						.addBox(-4.0F, 0.0F, -3.5F, 8.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(30, 35)
						.addBox(-2.4858F, 1.5F, -4.0F, 5.0F, 3.0F, 1.0F, new CubeDeformation(0.15F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition RightArm = Head.addOrReplaceChild("RightArm",
		...
		PartDefinition RightLeg = Head.addOrReplaceChild("RightLeg",
