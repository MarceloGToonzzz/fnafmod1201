...
public class ModelFreddyFazbearSuit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "freddyfazbearsuit"), "main");
	private final ModelPart Head;
	private final ModelPart FreddyHead;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FreddyHead = Head.addOrReplaceChild("FreddyHead",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -3.6F, -5.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.1F)).texOffs(16, 44)
						.addBox(-3.0F, -4.6F, -4.5F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(32, 61)
						.addBox(-2.0F, -7.6F, -3.5F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 17)
						.addBox(-4.5F, 0.4F, -5.0F, 9.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 24)
						.addBox(-3.0F, 1.4F, -7.1F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(70, 39)
						.addBox(-1.0F, 0.9F, -7.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -4.6F, 1.0F));

		PartDefinition RightEyebrow = FreddyHead.addOrReplaceChild("RightEyebrow", CubeListBuilder.create(),
				PartPose.offset(-2.0F, -5.3968F, -4.4077F));

		PartDefinition Head_r1 = RightEyebrow.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(16, 42).addBox(-4.0F, -1.4F, 0.8F, 4.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 4.3657F, -2.2037F, -0.8727F, 0.0F, 0.0F));

		PartDefinition LeftEyebrow = FreddyHead.addOrReplaceChild("LeftEyebrow", CubeListBuilder.create(),
				PartPose.offset(2.0F, -5.3968F, -4.4077F));

		PartDefinition Head_r2 = LeftEyebrow.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(16, 43).addBox(0.0F, -1.4F, 0.8F, 4.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 4.3657F, -2.2037F, -0.8727F, 0.0F, 0.0F));

		PartDefinition Jaw = FreddyHead.addOrReplaceChild("Jaw",
				CubeListBuilder.create().texOffs(32, 9)
						.addBox(-3.5F, 3.4913F, -7.7047F, 7.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(16, 39)
						.addBox(-2.5F, 2.7413F, -6.7047F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.7F, 0.1F, 0.2618F, 0.0F, 0.0F));

		PartDefinition Ears = FreddyHead.addOrReplaceChild("Ears", CubeListBuilder.create(),
				PartPose.offset(0.0F, -5.5587F, -2.5F));

		PartDefinition RightEar = Ears.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(70, 35)
						.addBox(-5.5651F, -3.0662F, -1.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(56, 68)
						.addBox(-5.5651F, -3.0662F, -1.0F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0068F, 0.0F, 0.0F, 0.0F, 0.0F, -1.1781F));

		PartDefinition LeftEar = Ears.addOrReplaceChild("LeftEar", CubeListBuilder.create().texOffs(70, 31)
				.addBox(2.9186F, -2.6292F, -4.0725F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(70, 51)
				.addBox(2.9186F, -2.6292F, -3.5725F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition HandR_r1 = RightHand.addOrReplaceChild("HandR_r1",
				CubeListBuilder.create().texOffs(24, 42)
						...
						.addBox(-0.5F, -0.8F, 0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(-0.21F, 3.2F, 0.0F, 0.0F, 0.0F, 0.6981F));

		PartDefinition HandR_r2 = RightHand.addOrReplaceChild("HandR_r2",
				CubeListBuilder.create().texOffs(48, 24).addBox(-0.5F, -0.8F, -0.9F, 2.0F, 1.0F, 1.0F,
						new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(-0.21F, 3.2F, 0.0F, 0.0F, 0.0F, 0.6981F));
