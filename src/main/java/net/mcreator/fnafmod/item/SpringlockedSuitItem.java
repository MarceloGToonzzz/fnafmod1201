...
public abstract class SpringlockedSuitItem extends ArmorItem {
	public SpringlockedSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends SpringlockedSuitItem {
		public Helmet() {
	...
	public static class Chestplate extends SpringlockedSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends SpringlockedSuitItem {
		public Leggings() {
