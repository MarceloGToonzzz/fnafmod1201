...
public abstract class YellowBearSuitItem extends ArmorItem {
	public YellowBearSuitItem(ArmorItem.Type type, Item.Properties properties) {
	...
	public static class Helmet extends YellowBearSuitItem {
		public Helmet() {
	...
	public static class Chestplate extends YellowBearSuitItem {
		public Chestplate() {
	...
	public static class Leggings extends YellowBearSuitItem {
		public Leggings() {
	...
	public static class Boots extends YellowBearSuitItem {
		public Boots() {
