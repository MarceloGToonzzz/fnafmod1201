...
public abstract class BonnieSuitItem extends ArmorItem {
	...
	public static class Helmet extends BonnieSuitItem {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelBonnieMask(Minecraft.getInstance().getEntityModels().bakeLayer(ModelBonnieMask.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fnaf_mod:textures/entities/bonnie_head.png";
		}
	...
	public static class Chestplate extends BonnieSuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fnaf_mod:textures/entities/bonnie_layer_1.png";
		}
	...
	public static class Leggings extends BonnieSuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fnaf_mod:textures/entities/bonnie_layer_2.png";
		}
