...
public abstract class FoxySuitItem extends ArmorItem {
	...
	public static class Helmet extends FoxySuitItem {
			...
			consumer.accept(new IClientItemExtensions() {
				...
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("head", new ModelFoxyMask(Minecraft.getInstance().getEntityModels().bakeLayer(ModelFoxyMask.LAYER_LOCATION)).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fnaf_mod:textures/entities/foxy_head.png";
		}
	...
	public static class Chestplate extends FoxySuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fnaf_mod:textures/entities/foxy_layer_1.png";
		}
	...
	public static class Leggings extends FoxySuitItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "fnaf_mod:textures/entities/foxy_layer_2.png";
		}
