...
public class LockerMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LockerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FnafModModMenus.LOCKER.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 61, 17) {
			...
			private int x = LockerMenu.this.x;
			private int y = LockerMenu.this.y;
		}));
