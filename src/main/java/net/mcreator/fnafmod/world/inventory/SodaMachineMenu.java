...
public class SodaMachineMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SodaMachineMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FnafModModMenus.SODA_MACHINE.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 61, 17) {
			...
			private int x = SodaMachineMenu.this.x;
			private int y = SodaMachineMenu.this.y;
		}));
