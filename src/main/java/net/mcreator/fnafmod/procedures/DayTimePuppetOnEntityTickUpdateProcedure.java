...
public class DayTimePuppetOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (!(world instanceof Level _lvl10 && _lvl10.isDay())) {
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = FnafModModEntities.PUPPET.get().spawn(_level, BlockPos.containing(entity.getPersistentData().getDouble("spawnX"), entity.getPersistentData().getDouble("spawnY"), entity.getPersistentData().getDouble("spawnZ")),
