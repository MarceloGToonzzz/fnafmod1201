...
public class PrizeCounterBlockAddedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate) {
		if ((new Object() {
			...
			} else if ((world.getBlockState(BlockPos.containing(x + 1, y, z))).getBlock() == blockstate.getBlock()) {
				{
					int _value = 3;
					BlockPos _pos = BlockPos.containing(x, y, z);
					BlockState _bs = world.getBlockState(_pos);
			...
			} else if ((world.getBlockState(BlockPos.containing(x, y, z + 1))).getBlock() == blockstate.getBlock()) {
				{
					int _value = 3;
					BlockPos _pos = BlockPos.containing(x, y, z);
					BlockState _bs = world.getBlockState(_pos);
