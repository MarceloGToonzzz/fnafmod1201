...
public class GenCreativePowerReturnProcedure {
	public static String execute(LevelAccessor world, double x, double y, double z) {
		if (new Object() {
		...
		}.getValue(world, BlockPos.containing(x, y, z), "GenLinkZ")), "Power") >= 100) {
			...
			}.getValue(world, BlockPos.containing(x, y, z), "GenLinkZ")), "Power")) + "%";
		}
		return " " + new java.text.DecimalFormat("##").format(new Object() {
			public double getValue(LevelAccessor world, BlockPos pos, String tag) {
				BlockEntity blockEntity = world.getBlockEntity(pos);
