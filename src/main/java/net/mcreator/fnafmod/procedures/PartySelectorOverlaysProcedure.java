...
public class PartySelectorOverlaysProcedure {
	...
	private static boolean target(int targetStage) {
		if (targetStage == currentStage) {
			PartySelectorOverlaysProcedure.targetStage = targetStage;
			return true;
		} else if (targetStage == 1) {
			if (currentStage != 0) {
				PartySelectorOverlaysProcedure.targetStage = currentStage;
				return true;
			}
		}
		return false;
	...
	private static void execute(@Nullable Event event) {
		if (target(3)) {
			if (Minecraft.getInstance().player != null) {
				...
				if (entity instanceof Player _plr0 && _plr0.containerMenu instanceof PartySystemMenu) {
					RenderSystem.defaultBlendFunc();
					RenderSystem.setShaderTexture(0, new ResourceLocation(("fnaf_mod" + ":textures/" + "screens/party_selector" + ".png")));
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember0)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(0, 0),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember0)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember0)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember1)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(1, 0),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember1)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember1)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember2)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(2, 0),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember2)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember2)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember3)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(3, 0),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember3)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember3)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember4)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(0, 1),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember4)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember4)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember5)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(1, 1),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember5)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember5)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember6)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(2, 1),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember6)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember6)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
					if (!(-1 == (entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember7)) {
						renderShape(GetPartySelectorTextureUVsProcedure.execute(3, 1),
								(Minecraft.getInstance().getWindow().getGuiScaledWidth() / 2
										+ PartyIndexToXPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember7)),
								(Minecraft.getInstance().getWindow().getGuiScaledHeight() / 2
										+ PartyIndexToYPositionProcedure.execute((entity.getCapability(FnafModModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new FnafModModVariables.PlayerVariables())).partyMember7)),
								0, 0, 0, 0, 1, 1, 1, 255 << 24 | 255 << 16 | 255 << 8 | 255);
					}
				}
			}
