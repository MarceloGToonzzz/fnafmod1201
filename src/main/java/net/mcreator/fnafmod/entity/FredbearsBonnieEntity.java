...
public class FredbearsBonnieEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FredbearsBonnieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FredbearsBonnieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FredbearsBonnieEntity.class, EntityDataSerializers.STRING);
	...
	public FredbearsBonnieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.FREDBEARS_BONNIE.get(), world);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(FredbearsBonnieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
