...
public class WitheredFoxyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(WitheredFoxyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(WitheredFoxyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(WitheredFoxyEntity.class, EntityDataSerializers.STRING);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WitheredFoxyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
