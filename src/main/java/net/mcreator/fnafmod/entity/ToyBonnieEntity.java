...
public class ToyBonnieEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ToyBonnieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ToyBonnieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ToyBonnieEntity.class, EntityDataSerializers.STRING);
	...
	public ToyBonnieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.TOY_BONNIE.get(), world);
	}

	public ToyBonnieEntity(EntityType<ToyBonnieEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8) {
			...
			public boolean canUse() {
				double x = ToyBonnieEntity.this.getX();
				double y = ToyBonnieEntity.this.getY();
				double z = ToyBonnieEntity.this.getZ();
				Entity entity = ToyBonnieEntity.this;
				Level world = ToyBonnieEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ToyBonnieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
