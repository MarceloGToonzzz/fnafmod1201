...
public class BonnieStandEntity extends PathfinderMob {
	public BonnieStandEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.BONNIE_STAND.get(), world);
	}

	public BonnieStandEntity(EntityType<BonnieStandEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(FnafModModItems.BONNIE_STAND_SPAWN_EGG.get()));
	}
