...
public class GoldenFreddyEntity extends PathfinderMob implements GeoEntity {
	...
	public GoldenFreddyEntity(EntityType<GoldenFreddyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.freddyfazbear.sit"));
		}
