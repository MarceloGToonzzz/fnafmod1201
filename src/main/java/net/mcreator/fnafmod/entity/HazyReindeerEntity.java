...
public class HazyReindeerEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(HazyReindeerEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(HazyReindeerEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(HazyReindeerEntity.class, EntityDataSerializers.STRING);
	...
	public HazyReindeerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.HAZY_REINDEER.get(), world);
	}

	public HazyReindeerEntity(EntityType<HazyReindeerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(HazyReindeerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
