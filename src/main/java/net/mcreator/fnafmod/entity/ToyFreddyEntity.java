...
public class ToyFreddyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ToyFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ToyFreddyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ToyFreddyEntity.class, EntityDataSerializers.STRING);
	...
	public ToyFreddyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.TOY_FREDDY.get(), world);
	}

	public ToyFreddyEntity(EntityType<ToyFreddyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8) {
			...
			public boolean canUse() {
				double x = ToyFreddyEntity.this.getX();
				double y = ToyFreddyEntity.this.getY();
				double z = ToyFreddyEntity.this.getZ();
				Entity entity = ToyFreddyEntity.this;
				Level world = ToyFreddyEntity.this.level();
		...
		this.goalSelector.addGoal(4, new MeleeAttackGoal(this, 1.2, false) {
			...
			public boolean canUse() {
				...
				Entity entity = ToyFreddyEntity.this;
				Level world = ToyFreddyEntity.this.level();
				return super.canUse() && AttackProcedure.execute(world, entity);
			}
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			if (this.isAggressive() && event.isMoving()) {
				return event.setAndContinue(RawAnimation.begin().thenLoop("animation.toyfreddy.chase"));
			}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ToyFreddyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
