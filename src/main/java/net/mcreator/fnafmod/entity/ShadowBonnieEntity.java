...
public class ShadowBonnieEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ShadowBonnieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ShadowBonnieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ShadowBonnieEntity.class, EntityDataSerializers.STRING);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "shadow_bonnie");
	}
	...
	public static void init() {
		SpawnPlacements.register(FnafModModEntities.SHADOW_BONNIE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShadowBonnieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
