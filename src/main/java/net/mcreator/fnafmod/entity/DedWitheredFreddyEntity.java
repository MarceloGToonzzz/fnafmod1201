...
public class DedWitheredFreddyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DedWitheredFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DedWitheredFreddyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DedWitheredFreddyEntity.class, EntityDataSerializers.STRING);
	...
	public DedWitheredFreddyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.DED_WITHERED_FREDDY.get(), world);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DedWitheredFreddyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
