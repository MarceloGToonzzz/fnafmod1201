...
public class PuffyPuffinsEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PuffyPuffinsEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PuffyPuffinsEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PuffyPuffinsEntity.class, EntityDataSerializers.STRING);
	...
	public PuffyPuffinsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.PUFFY_PUFFINS.get(), world);
	}

	public PuffyPuffinsEntity(EntityType<PuffyPuffinsEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PuffyPuffinsEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
