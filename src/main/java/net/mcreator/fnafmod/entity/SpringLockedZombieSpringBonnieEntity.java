...
public class SpringLockedZombieSpringBonnieEntity extends Zombie {
	...
	public SpringLockedZombieSpringBonnieEntity(EntityType<SpringLockedZombieSpringBonnieEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
		...
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(FnafModModItems.SPRINGLOCKED_SUIT_BOOTS.get()));
	}
