...
public class UnwitheredFreddyEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(UnwitheredFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(UnwitheredFreddyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(UnwitheredFreddyEntity.class, EntityDataSerializers.STRING);
	...
	public UnwitheredFreddyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.UNWITHERED_FREDDY.get(), world);
	}

	public UnwitheredFreddyEntity(EntityType<UnwitheredFreddyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(UnwitheredFreddyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
