...
public class ToyChicaEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ToyChicaEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ToyChicaEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ToyChicaEntity.class, EntityDataSerializers.STRING);
	...
	public ToyChicaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.TOY_CHICA.get(), world);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ToyChicaEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
