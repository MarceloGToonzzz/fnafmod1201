...
public class ToyFoxyModel extends GeoModel<ToyFoxyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(ToyFoxyEntity animatable, long instanceId, AnimationState animationState) {
