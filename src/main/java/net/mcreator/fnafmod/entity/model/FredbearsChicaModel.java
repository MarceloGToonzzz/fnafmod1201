...
public class FredbearsChicaModel extends GeoModel<FredbearsChicaEntity> {
	...
	@Override
	public ResourceLocation getTextureResource(FredbearsChicaEntity entity) {
		return new ResourceLocation("fnaf_mod", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(FredbearsChicaEntity animatable, long instanceId, AnimationState animationState) {
