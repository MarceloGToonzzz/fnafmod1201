...
public class StatueChicaModel extends GeoModel<StatueChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(StatueChicaEntity animatable, long instanceId, AnimationState animationState) {
