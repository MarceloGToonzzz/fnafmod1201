...
public class ToyFreddyModel extends GeoModel<ToyFreddyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(ToyFreddyEntity animatable, long instanceId, AnimationState animationState) {
