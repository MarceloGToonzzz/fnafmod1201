...
public class UnwitheredFoxyModel extends GeoModel<UnwitheredFoxyEntity> {
	...
	@Override
	public ResourceLocation getTextureResource(UnwitheredFoxyEntity entity) {
		return new ResourceLocation("fnaf_mod", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(UnwitheredFoxyEntity animatable, long instanceId, AnimationState animationState) {
