...
public class BarryPolarEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BarryPolarEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BarryPolarEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BarryPolarEntity.class, EntityDataSerializers.STRING);
	...
	public BarryPolarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.BARRY_POLAR.get(), world);
	}

	public BarryPolarEntity(EntityType<BarryPolarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(BarryPolarEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
