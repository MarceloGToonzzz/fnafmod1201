...
public class ToyBoxEntity extends PathfinderMob {
	public ToyBoxEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.TOY_BOX.get(), world);
	}

	public ToyBoxEntity(EntityType<ToyBoxEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
