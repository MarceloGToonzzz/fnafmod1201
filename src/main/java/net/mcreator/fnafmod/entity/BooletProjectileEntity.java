...
public class BooletProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public static BooletProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 3f, 4, 0);
	}
