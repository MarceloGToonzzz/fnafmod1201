...
public class WallyWalrusEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(WallyWalrusEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(WallyWalrusEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(WallyWalrusEntity.class, EntityDataSerializers.STRING);
	...
	public WallyWalrusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.WALLY_WALRUS.get(), world);
	}

	public WallyWalrusEntity(EntityType<WallyWalrusEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WallyWalrusEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
