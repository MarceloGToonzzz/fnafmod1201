...
public class ChicaChickenEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ChicaChickenEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ChicaChickenEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ChicaChickenEntity.class, EntityDataSerializers.STRING);
	...
	public ChicaChickenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.CHICA_CHICKEN.get(), world);
	}

	public ChicaChickenEntity(EntityType<ChicaChickenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			if (this.isAggressive() && event.isMoving()) {
				return event.setAndContinue(RawAnimation.begin().thenLoop("animation.chica.aggression"));
			}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ChicaChickenEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
