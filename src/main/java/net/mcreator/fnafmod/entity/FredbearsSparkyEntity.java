...
public class FredbearsSparkyEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FredbearsSparkyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FredbearsSparkyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FredbearsSparkyEntity.class, EntityDataSerializers.STRING);
	...
	public FredbearsSparkyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.FREDBEARS_SPARKY.get(), world);
	}

	public FredbearsSparkyEntity(EntityType<FredbearsSparkyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "diner_sparky");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(FredbearsSparkyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
