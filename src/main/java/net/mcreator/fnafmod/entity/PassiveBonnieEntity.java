...
public class PassiveBonnieEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PassiveBonnieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PassiveBonnieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PassiveBonnieEntity.class, EntityDataSerializers.STRING);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(PassiveBonnieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
