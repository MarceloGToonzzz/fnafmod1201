...
public class UnwitheredBonnieEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(UnwitheredBonnieEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(UnwitheredBonnieEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(UnwitheredBonnieEntity.class, EntityDataSerializers.STRING);
	...
	public UnwitheredBonnieEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.UNWITHERED_BONNIE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RandomStrollGoal(this, 0.8) {
			...
			public boolean canUse() {
				double x = UnwitheredBonnieEntity.this.getX();
				double y = UnwitheredBonnieEntity.this.getY();
				double z = UnwitheredBonnieEntity.this.getZ();
				Entity entity = UnwitheredBonnieEntity.this;
				Level world = UnwitheredBonnieEntity.this.level();
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(UnwitheredBonnieEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
