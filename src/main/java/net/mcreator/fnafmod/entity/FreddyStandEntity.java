...
public class FreddyStandEntity extends PathfinderMob {
	public FreddyStandEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.FREDDY_STAND.get(), world);
	}

	public FreddyStandEntity(EntityType<FreddyStandEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(FnafModModItems.FREDDY_STAND_SPAWN_EGG.get()));
	}
