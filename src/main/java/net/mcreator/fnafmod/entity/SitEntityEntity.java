...
public class SitEntityEntity extends PathfinderMob {
	...
	public SitEntityEntity(EntityType<SitEntityEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(true);
	...
	public static void init() {
		SpawnPlacements.register(FnafModModEntities.SIT_ENTITY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
