...
public class DayTimeToyFreddyEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DayTimeToyFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DayTimeToyFreddyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DayTimeToyFreddyEntity.class, EntityDataSerializers.STRING);
	...
	public DayTimeToyFreddyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FnafModModEntities.DAY_TIME_TOY_FREDDY.get(), world);
	}

	public DayTimeToyFreddyEntity(EntityType<DayTimeToyFreddyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new RandomStrollGoal(this, 1) {
			...
			public boolean canUse() {
				double x = DayTimeToyFreddyEntity.this.getX();
				double y = DayTimeToyFreddyEntity.this.getY();
				double z = DayTimeToyFreddyEntity.this.getZ();
				Entity entity = DayTimeToyFreddyEntity.this;
				Level world = DayTimeToyFreddyEntity.this.level();
	...
	public void die(DamageSource source) {
		super.die(source);
		DayTimeToyFreddyEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(DayTimeToyFreddyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
