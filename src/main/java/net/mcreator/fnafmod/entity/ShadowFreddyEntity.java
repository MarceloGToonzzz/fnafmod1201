...
public class ShadowFreddyEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ShadowFreddyEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ShadowFreddyEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ShadowFreddyEntity.class, EntityDataSerializers.STRING);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "withered-shadow-freddy");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ShadowFreddyEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
