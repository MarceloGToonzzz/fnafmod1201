...
public class FnafModModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(ModelSparkySuit.LAYER_LOCATION, ModelSparkySuit::createBodyLayer);
		event.registerLayerDefinition(ModelFredbearFNAF4.LAYER_LOCATION, ModelFredbearFNAF4::createBodyLayer);
		event.registerLayerDefinition(ModelFoxySuit.LAYER_LOCATION, ModelFoxySuit::createBodyLayer);
		...
		event.registerLayerDefinition(ModelBonnieSuit.LAYER_LOCATION, ModelBonnieSuit::createBodyLayer);
		...
		event.registerLayerDefinition(ModelFreddyFazbearSuit.LAYER_LOCATION, ModelFreddyFazbearSuit::createBodyLayer);
		...
		event.registerLayerDefinition(ModelChicaSuit.LAYER_LOCATION, ModelChicaSuit::createBodyLayer);
