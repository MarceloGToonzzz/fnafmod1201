...
public class AdventureNightmareFredbearRenderer extends GeoEntityRenderer<AdventureNightmareFredbearEntity> {
	...
	@Override
	public RenderType getRenderType(AdventureNightmareFredbearEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, AdventureNightmareFredbearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
