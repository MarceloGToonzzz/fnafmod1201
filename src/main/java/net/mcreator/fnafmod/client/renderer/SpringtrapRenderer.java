...
public class SpringtrapRenderer extends GeoEntityRenderer<SpringtrapEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SpringtrapEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
