...
public class SecretNightmareFredbearRenderer extends GeoEntityRenderer<SecretNightmareFredbearEntity> {
	public SecretNightmareFredbearRenderer(EntityRendererProvider.Context renderManager) {
		...
		this.addRenderLayer(new SecretNightmareFredbearLayer(this));
	}

	@Override
	public RenderType getRenderType(SecretNightmareFredbearEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	@Override
	public void preRender(PoseStack poseStack, SecretNightmareFredbearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
