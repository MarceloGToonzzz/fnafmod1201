...
public class ModelChicaSuit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_chica_suit"), "main");
	public final ModelPart Head;
	public final ModelPart Chica_Head;
	public final ModelPart Jaw;
	public final ModelPart MainJaw;
	public final ModelPart Folder;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition MainJaw = Jaw.addOrReplaceChild("MainJaw", CubeListBuilder.create().texOffs(18, 3).addBox(-2.1F, -6.3F, -1.5F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.15F, -4.2F));
		PartDefinition Folder = Chica_Head.addOrReplaceChild("Folder", CubeListBuilder.create(), PartPose.offset(0.0F, 28.0F, -1.0F));
		PartDefinition bone14 = Folder.addOrReplaceChild("bone14", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, -40.5743F, -1.0001F, 0.0F, 2.0944F, 0.0F));
		PartDefinition bone12 = Folder.addOrReplaceChild("bone12", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, -40.5743F, -1.0001F, 0.0F, -2.0944F, 0.0F));
		PartDefinition bone13 = bone12.addOrReplaceChild("bone13", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 2.0944F, 0.0F));
		PartDefinition bone2 = bone13.addOrReplaceChild("bone2", CubeListBuilder.create(), PartPose.offset(0.0F, 3.5743F, 1.5001F));
		PartDefinition cube_r1 = bone2.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 64).addBox(-1.5F, -1.0F, -4.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -4.0F, 0.0F, 2.7489F, 1.0472F, 3.1416F));
		PartDefinition cube_r2 = bone2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 64).addBox(-1.5F, -1.0F, -4.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -4.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r3 = bone2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 64).addBox(-1.5F, -1.0F, -4.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -4.0F, 0.0F, 2.7489F, -1.0472F, 3.1416F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(32, 0).addBox(-4.5F, 10.0F, -3.0F, 9.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 15).addBox(-4.5F, 4.0F, -3.5F, 9.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 28)
						.addBox(-4.0F, 0.0F, -3.5F, 8.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(2, 42).addBox(-4.0F, -0.125F, -3.7F, 8.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightBoot = partdefinition.addOrReplaceChild("RightBoot", CubeListBuilder.create().texOffs(34, 54).addBox(-2.0F, 10.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
		...
		PartDefinition FootR_r2 = RightBoot.addOrReplaceChild("FootR_r2", CubeListBuilder.create().texOffs(62, 67).addBox(-0.3F, -1.0F, -5.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.001F)),
				PartPose.offsetAndRotation(-0.1068F, 11.003F, -1.4608F, 0.0F, -0.3927F, 0.0F));
		PartDefinition LeftBoot = partdefinition.addOrReplaceChild("LeftBoot", CubeListBuilder.create().texOffs(52, 54).addBox(-2.0F, 10.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
