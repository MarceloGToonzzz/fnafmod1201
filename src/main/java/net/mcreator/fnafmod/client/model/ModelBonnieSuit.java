...
public class ModelBonnieSuit<T extends Entity> extends EntityModel<T> {
	...
	public final ModelPart Bonnie_Head;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Bonnie_Head = Head.addOrReplaceChild("Bonnie_Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.1F)).texOffs(74, 11).addBox(-5.0F, -4.0F, -4.0F, 10.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 24)
						.addBox(-3.0F, -3.0F, -6.1F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(70, 39).addBox(-1.0F, -3.5F, -6.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -0.3F, 0.0F));
		PartDefinition EarR = Bonnie_Head.addOrReplaceChild("EarR",
				CubeListBuilder.create().texOffs(30, 40).addBox(-1.5F, -6.999F, -0.4982F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 43).addBox(-1.0F, -7.0F, 0.0F, 2.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.15F, -6.5F, -1.3F, 0.0F, 0.1745F, -0.2618F));
		PartDefinition Top = EarR.addOrReplaceChild("Top", CubeListBuilder.create(), PartPose.offsetAndRotation(0.9F, -7.0F, 0.025F, -0.5236F, 0.0F, 0.0F));
		PartDefinition RightEar_r1 = Top.addOrReplaceChild("RightEar_r1", CubeListBuilder.create().texOffs(0, 39).addBox(-1.0F, -2.5F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9F, -0.3003F, -1.4699F, 1.3526F, 0.0F, 0.0F));
		PartDefinition cube_r1 = Top.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(30, 35).addBox(-3.4F, -45.2438F, -2.859F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 6.5389F, 40.2834F, 1.3526F, 0.0F, 0.0F));
		PartDefinition EarL = Bonnie_Head.addOrReplaceChild("EarL",
				CubeListBuilder.create().texOffs(38, 40).addBox(-1.5431F, -6.9981F, -0.5431F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 43).addBox(-1.0F, -7.0F, 0.0F, 2.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.15F, -6.5F, -1.3F, 0.0F, -0.1745F, 0.2618F));
		PartDefinition Top2 = EarL.addOrReplaceChild("Top2",
				CubeListBuilder.create().texOffs(38, 35).addBox(-1.5431F, -4.4981F, -0.5431F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 39).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, 0.8727F, 0.0F, 0.0F));
		PartDefinition Jaw = Bonnie_Head.addOrReplaceChild("Jaw", CubeListBuilder.create().texOffs(15, 29).addBox(-4.5F, -0.25F, -2.6F, 9.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 10)
				.addBox(-3.5F, -0.25F, -5.6F, 7.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(16, 39).addBox(-2.5F, -1.25F, -4.6F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.7F, 0.1F));
