...
public class ModelFoxySuit<T extends Entity> extends EntityModel<T> {
	...
	public final ModelPart Eyepatch;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Mask = Head2.addOrReplaceChild("Mask",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -2.8F, -3.0F, 8.0F, 7.0F, 8.0F, new CubeDeformation(0.1F)).texOffs(74, 14).addBox(-6.0F, 2.2F, -3.0F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(13, 45)
						.addBox(-1.5F, -4.8F, 0.0F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(16, 15).addBox(-2.5F, 2.2F, -6.0F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(22, 20)
						.addBox(-1.5F, 2.2F, -8.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-1.0F, 1.2F, -8.4F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 30)
						.addBox(-1.5F, 4.2F, -7.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -6.45F, -1.0F));
		PartDefinition cube_r1 = Mask.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(16, 7).addBox(-4.5F, -2.1F, 0.1F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 0.2688F, -4.6113F, -0.8727F, 0.0F, 0.0F));
		PartDefinition cube_r2 = Mask.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(15, 45).addBox(0.0F, -1.0F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.8F, 0.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition Eyepatch = Mask.addOrReplaceChild("Eyepatch", CubeListBuilder.create().texOffs(13, 20).addBox(-3.0F, -1.0F, 0.0F, 4.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 0.2F, -3.15F));
		PartDefinition Ears = Head2.addOrReplaceChild("Ears", CubeListBuilder.create(), PartPose.offset(0.0F, -7.0184F, -1.275F));
		PartDefinition EarR = Ears.addOrReplaceChild("EarR", CubeListBuilder.create().texOffs(0, 15).addBox(-1.5741F, -6.505F, -0.7582F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5259F, 0.0F, 0.0F, 0.0F, 0.0F, -0.6109F));
		PartDefinition EarL = Ears.addOrReplaceChild("EarL", CubeListBuilder.create().texOffs(8, 15).addBox(-1.3899F, -6.5117F, -0.499F, 3.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5259F, 0.0F, 0.0F, 0.0F, 0.0F, 0.6109F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(0, 55).addBox(-0.99F, 5.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(58, 9)
				.addBox(-1.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(48, 61).addBox(-0.5F, -2.0F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(5.0F, 2.0F, 0.0F));
		...
		PartDefinition HandL_r1 = LeftHand.addOrReplaceChild("HandL_r1", CubeListBuilder.create().texOffs(12, 64).addBox(-2.0F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(1.8F, 1.4F, 2.3F, 0.6109F, 0.0F, 0.0F));
		PartDefinition HandL_r2 = LeftHand.addOrReplaceChild("HandL_r2", CubeListBuilder.create().texOffs(48, 24).addBox(-0.7F, -0.8F, 0.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(48, 26)
				.addBox(-0.7F, -0.8F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(48, 24).addBox(-0.7F, -0.8F, -1.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, 3.2F, 0.0F, 0.0F, 0.0F, 0.6981F));
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(58, 42).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(16, 61)
				.addBox(-3.0F, 5.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(62, 0).addBox(-2.49F, -2.0F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition RightHand = RightArm.addOrReplaceChild("RightHand", CubeListBuilder.create(), PartPose.offset(-1.09F, 10.3F, -1.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(33, 4).addBox(-4.0F, 9.4F, -2.5F, 8.0F, 3.0F, 5.0F, new CubeDeformation(0.1F)).texOffs(0, 21).addBox(-4.0F, 0.0F, -2.5F, 8.0F, 9.0F, 5.0F, new CubeDeformation(0.1F)),
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(54, 33).addBox(-2.0F, 4.9F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(70, 18)
				.addBox(-1.5F, 3.5F, -3.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(17, 52).addBox(-2.0436F, -0.4F, -2.0019F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)), PartPose.offset(-1.9F, 12.0F, 0.0F));
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(41, 45).addBox(-2.0F, -0.4F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.1F)).texOffs(70, 22)
