...
import net.mcreator.fnafmod.procedures.ExitKeyPressedProcedure;
...
public class ExitCameraMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			ExitKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		FnafModMod.addNetworkMessage(ExitCameraMessage.class, ExitCameraMessage::buffer, ExitCameraMessage::new, ExitCameraMessage::handler);
	}
}
