...
public class GeneratorBreakerUnpaneledButtonMessage {
	private final int buttonID, x, y, z;

	public GeneratorBreakerUnpaneledButtonMessage(FriendlyByteBuf buffer) {
	...
	public GeneratorBreakerUnpaneledButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(GeneratorBreakerUnpaneledButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GeneratorBreakerUnpaneledButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = GeneratorBreakerUnpaneledMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		FnafModMod.addNetworkMessage(GeneratorBreakerUnpaneledButtonMessage.class, GeneratorBreakerUnpaneledButtonMessage::buffer, GeneratorBreakerUnpaneledButtonMessage::new, GeneratorBreakerUnpaneledButtonMessage::handler);
	}
}
