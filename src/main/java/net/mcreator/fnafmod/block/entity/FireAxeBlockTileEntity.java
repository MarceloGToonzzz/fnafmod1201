...
public class FireAxeBlockTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FireAxeBlockTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.FIRE_AXE_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FireAxeBlockBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FireAxeBlockTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FireAxeBlockTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fire_axe_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Fire Axe Block");
	}
