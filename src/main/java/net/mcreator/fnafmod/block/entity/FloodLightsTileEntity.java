...
public class FloodLightsTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FloodLightsTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.FLOOD_LIGHTS.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FloodLightsBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FloodLightsTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FloodLightsTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("flood_lights");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Flood Lights");
	}
