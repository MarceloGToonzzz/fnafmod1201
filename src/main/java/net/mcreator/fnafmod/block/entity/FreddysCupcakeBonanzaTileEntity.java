...
public class FreddysCupcakeBonanzaTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FreddysCupcakeBonanzaTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.FREDDYS_CUPCAKE_BONANZA.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FreddysCupcakeBonanzaBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FreddysCupcakeBonanzaTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FreddysCupcakeBonanzaTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("freddys_cupcake_bonanza");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Freddy's Cupcake Bonanza");
	}
