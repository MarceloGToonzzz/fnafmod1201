...
public class ProtonsPlushRatTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ProtonsPlushRatTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.PROTONS_PLUSH_RAT.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(ProtonsPlushRatBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<ProtonsPlushRatTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<ProtonsPlushRatTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("protons_plush_rat");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Protons Plush Rat");
	}
