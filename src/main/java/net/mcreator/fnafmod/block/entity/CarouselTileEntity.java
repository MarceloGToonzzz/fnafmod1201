...
public class CarouselTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public int blockstateNew = this.getBlockState().getValue(CarouselBlock.BLOCKSTATE);
	private int blockstateOld = this.getBlockState().getValue(CarouselBlock.BLOCKSTATE);

	public CarouselTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.CAROUSEL.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		blockstateNew = this.getBlockState().getValue(CarouselBlock.BLOCKSTATE);
	...
	public Component getDefaultName() {
		return Component.literal("carousel");
	}
