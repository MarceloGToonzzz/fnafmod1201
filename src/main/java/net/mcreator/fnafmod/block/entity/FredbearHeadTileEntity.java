...
public class FredbearHeadTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FredbearHeadTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.FREDBEAR_HEAD.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FredbearHeadBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FredbearHeadTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FredbearHeadTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fredbear_head");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Fredbear Head");
	}
