...
public class UnWitheredFreddyHeadTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public UnWitheredFreddyHeadTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.UN_WITHERED_FREDDY_HEAD.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(UnWitheredFreddyHeadBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<UnWitheredFreddyHeadTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<UnWitheredFreddyHeadTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("un_withered_freddy_head");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Un-Withered Freddy Head");
	}
