...
public class MeshTrashCanTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(MeshTrashCanBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MeshTrashCanTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MeshTrashCanTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("mesh_trash_can");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Mesh Trash Can");
	}
