...
public class FoxyHeadDecorationTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FoxyHeadDecorationTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.FOXY_HEAD_DECORATION.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FoxyHeadDecorationBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FoxyHeadDecorationTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FoxyHeadDecorationTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("foxy_head_decoration");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Foxy Head Prop");
	}
