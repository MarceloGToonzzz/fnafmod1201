...
public class FredbearsFetchTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FredbearsFetchTileEntity(BlockPos pos, BlockState state) {
		super(FnafModModBlockEntities.FREDBEARS_FETCH.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(FredbearsFetchBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<FredbearsFetchTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<FredbearsFetchTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fredbears_fetch");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Fredbear's Family Diner Fetch");
	}
