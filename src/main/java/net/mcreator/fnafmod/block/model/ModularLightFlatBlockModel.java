...
public class ModularLightFlatBlockModel extends GeoModel<ModularLightFlatTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(ModularLightFlatTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(ModularLightFlatTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(ModularLightFlatTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
