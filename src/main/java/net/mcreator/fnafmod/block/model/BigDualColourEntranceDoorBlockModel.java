...
public class BigDualColourEntranceDoorBlockModel extends GeoModel<BigDualColourEntranceDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigDualColourEntranceDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigDualColourEntranceDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigDualColourEntranceDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
