...
public class BigWideCyanKitchenDoorBlockModel extends GeoModel<BigWideCyanKitchenDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigWideCyanKitchenDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigWideCyanKitchenDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigWideCyanKitchenDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
