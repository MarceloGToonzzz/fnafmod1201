...
public class BigCyanKitchenDoorBlockModel extends GeoModel<BigCyanKitchenDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigCyanKitchenDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigCyanKitchenDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigCyanKitchenDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
