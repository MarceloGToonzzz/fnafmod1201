...
public class BigCyanBackstageDoorBlockModel extends GeoModel<BigCyanBackstageDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigCyanBackstageDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigCyanBackstageDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigCyanBackstageDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
