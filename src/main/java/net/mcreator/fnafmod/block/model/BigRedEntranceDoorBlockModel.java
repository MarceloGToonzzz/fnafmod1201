...
public class BigRedEntranceDoorBlockModel extends GeoModel<BigRedEntranceDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigRedEntranceDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigRedEntranceDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigRedEntranceDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
