...
public class BigBackstageDoorBlockModel extends GeoModel<BigBackstageDoorTileEntity> {
	@Override
	public ResourceLocation getAnimationResource(BigBackstageDoorTileEntity animatable) {
	...
	@Override
	public ResourceLocation getModelResource(BigBackstageDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
	...
	@Override
	public ResourceLocation getTextureResource(BigBackstageDoorTileEntity animatable) {
		final int blockstate = animatable.blockstateNew;
		if (blockstate == 1)
